...
var copilotUrl = process.env.COPILOT_URL || 'http://localhost:3000';
...
app.message(/^!copilot\s+(.+)/, function (_a) {
    var message = _a.message, say = _a.say;
    return __awaiter(void 0, void 0, void 0, function () {
        var messageText, text, response, data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    messageText = 'text' in message && typeof message.text === 'string' ? message.text : '';
                    text = messageText.replace(/^!copilot\s+/, '').trim();
                    if (!text)
                        return [2 /*return*/];
                    return [4 /*yield*/, fetch("".concat(copilotUrl, "/api/admin/copilot/"), {
                            method: 'POST',
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                console.log("Slack bot running on port ".concat(port));
                return [2 /*return*/];
        }
    });
}); })();
