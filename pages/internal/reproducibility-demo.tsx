...
export default function ReproducibilityDemo() {
  ...
  return (
    <>
      <Head>
        <title>Reproducibility Demo — GTIXT (Internal)</title>
        <meta
          name="description"
      ...
      <InstitutionalHeader
        breadcrumbs={[{ label: 'Reproducibility Demo (Internal)', href: '/internal/reproducibility-demo' }]}
      />

      <main style={styles.container}>
        {/* Internal Page Badge */}
        <div style={styles.internalBadge}>
          <p style={styles.internalBadgeText}>🔒 INTERNAL PAGE</p>
        </div>
